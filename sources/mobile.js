	...
	(function(t)
	{
		...
		}, p.config = function(t)
		{
			...
			n = t, "object" === r()(n) && (i = function()
			{
				...
				{}, n = a.call(arguments, 1), e = n.length, o = 0; o < e; o++)
				{
					var r = n[o];
...
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, n, e)
{
	...
	e.r(n),
		function(t)
		{
									...
									n.nativeUI.confirm(t.note, (function(e)
									{
										if (0 == e.index) try
										{
											var o = n.nativeUI.showWaiting("正在下载",
												{}),
												r = n.downloader.createDownload(encodeURI(t.url),
												{}, (function(t, e)
												{
			...
			{
				var n, e, r;
				n = null, e = window.plus, r = e.webview.currentWebview(),
					function()
					{
						var n = window.plus;
			...
			t(".a-search")
				...
				function()
				{
					...
					})), n)
					{
						...
						{
							c() || (0 == e.scrollTop() && i > 25 ? window.location.reload() : o.hide("fast"))
