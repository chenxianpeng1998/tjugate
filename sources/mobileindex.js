	...
	e.m = t, e.c = n, e.d = function(t, n, o) {
		...
		function r(t, n) {
			for (var e = 0; e < n.length; e++) {
				var r = n[e];
				r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), o(t, r
					.key, r)
			}
		}
		...
		var o = e(17),
			...
			u = function(t, n, e) {
				var s, f, l, d = t & u.F,
					...
					b = p ? o : v ? o[n] : (o[n] || {})
					.prototype;
				for (s in p && (e = n), e)(f = !d && b && void 0 !== b[s]) && c(g, s) || (l = f ? b[s] : e[s], g[
						s] = p && "function" != typeof b[s] ? e[s] : m && f ? i(l, o) : y && b[s] == l ?
					function(
						t) {
					...
					}(l) : h && "function" == typeof l ? i(Function.call, l) : l, h && ((g.virtual || (g
						.virtual = {}))[s] = l, t & u.R && w && !w[s] && a(w, s, l)))
			};
		...
		function i(n) {
			return t.exports = i = "function" == typeof r && "symbol" == typeof o ? function(t) {
				...
				return t && "function" == typeof r && t.constructor === r && t !== r.prototype ? "symbol" :
					typeof t
			}, i(n)
		}
		t.exports = i
				...
				v = function() {
					...
					return d()(n, null, [{
						...
						value: function(t) {
							...
							n.style.width = "0px", n.style.height = "0px", n.innerText = t,
								document.body.appendChild(n);
							var e = document.createRange();
							e.selectNodeContents(n);
							var o = document.getSelection();
							o.removeAllRanges(), o.addRange(e), document.execCommand("copy"), n
								.remove()
						}
					}, {
						key: "alert",
						...
						value: function(t) {
							if (t = a()(t)) {
								var n = new Date(t);
								return n.getFullYear() + "-" + (n.getMonth() + 1) + "-" + n
									.getDate()
							}
							return ""
						}
						...
						value: function(t) {
							...
							for (var n, e = 0, o = 0; o < t.length; o++) e |= (n = t.charCodeAt(
									o)) >= 48 && n <= 57 ? 1 : n >= 65 && n <= 90 ? 2 : n >=
								97 && n <= 122 ? 4 : 8;
							return function(t) {
						...
						key: "save",
						value: function(t) {
							var n, e = arguments.length > 1 && void 0 !== arguments[1] ?
								arguments[1] : "application/json",
							...
							if ("function" == typeof r.Blob) n = new Blob([t], {
								...
								var c = r.BlobBuilder || r.MozBlobBuilder || r
									.WebKitBlobBuilder || r.MSBlobBuilder,
									u = new c;
							...
							if (navigator.msSaveBlob) navigator.msSaveBlob(n, o);
								...
								var s = r.URL || r.webkitURL,
									...
									l = a("a");
								if ("download" in l) {
									l.style.visibility = "hidden", l.href = f, l.download = o, i
										.body.appendChild(l);
									var d = i.createEvent("MouseEvents");
									d.initEvent("click", !0, !0), l.dispatchEvent(d), i.body
										.removeChild(l)
						...
						value: function(t, n) {
							var e = r()(),
								o = !0;
							return function() {
								for (var i = r()(), a = arguments.length, c = new Array(a),
										u = 0; u < a; u++) c[u] = arguments[u];
		...
		(function(t) {
			...
			function s() {
				return '<div class="modal fade" id="win_alert" tabindex="-1" role="dialog" aria-labelledby="win_alert_title">   <div class="modal-dialog modal-sm" role="document">       <div class="modal-content">           <div class="modal-header">               <h4 class="modal-title" id="win_alert_title">' +
					i.alert_title +
					'</h4>           </div>           <div class="modal-body" id="win_alert_msg">           </div>           <div class="modal-footer">               <button type="button" class="btn btn-primary win_alert_btn">' +
					i.alert_btn + "</button>           </div>       </div>   </div></div>"
			}
			...
			function l(n, e) {
				var o = t(
					'<div class="modal fade" id="win_confirm" tabindex="-1" role="dialog" aria-labelledby="win_confirm_title">   <div class="modal-dialog modal-sm" role="document">        <div class="modal-content">          <div class="modal-header">               <h4 class="modal-title" id="win_confirm_title">' +
					i.confirm_title +
					'</h4>            </div>         <div class="modal-body" id="win_confirm_msg">          确定删除？          </div>         <div class="modal-footer">               <button type="button" class="btn btn-default win_confirm_cancel" data-dismiss="modal">' +
					i.confirm_btn_cancel +
					'</button>              <button type="button" class="btn btn-primary win_confirm_ok">' +
					i.confirm_btn_ok + "</button>         </div>     </div> </div></div>");
			...
			p.alert = function(t, n) {
				...
				return o.on("hidden.bs.modal", (function() {
					...
					t.preventDefault(), r = !0, o.modal("hide"), c.alert = null, u(n) && n(this,
						r)
				})), o
				...
				var e = function(n) {
					var e = t('<div id="win_gritter"></div>'),
						...
						r = t(
							'<a class="win_close" href="javascript:void(0);"> <i class="fa fa-times"></i></a>'
						),
					...
					return e.css({
						...
						float: "right",
						color: "#DE431C"
					}), i.html(n), a.css("clear", "both"), r.appendTo(o), a.appendTo(o), o.appendTo(
						e), i.appendTo(e), e
				}(n);
				! function(t) {
				...
				! function(n, e) {
					...
					if (o)
						if ("granted" == o.permission) {
							...
							r.onclick = function() {
									r.close()
								}, r.onerror = function() {}, r.onshow = function() {}, r.onclose =
								function() {}
							...
							r.onclick = function() {}, r.onerror = function() {}, r.onshow =
								function() {}, r.onclose = function() {}
						}));
					else {
						var i, a = 0;
				...
				n = t, "object" === r()(n) && (i = function() {
					for (var t = arguments[0] || {}, n = a.call(arguments, 1), e = n.length, o =
							0; o < e; o++) {
						var r = n[o];
		...
		var o = e(24),
			...
			u = function() {
				...
				for (n.style.display = "none", e(97)
					...
					.open(), t.write("<script>document.F=Object<\/script>"), t.close(), u = t.F; o--;) delete u
					.prototype[i[o]];
				return u()
			};
		t.exports = Object.create || function(t, n) {
			var e;
			return null !== t ? (c.prototype = o(t), e = new c, c.prototype = null, e[a] = t) : e = u(),
				void 0 === n ? e : r(e, n)
		}
	}, , , , function(t, n, e) {
		var o = e(91),
		...
		e(133);
		for (var o = e(17), r = e(34), i = e(41), a = e(21)("toStringTag"), c =
		...
		t.exports = function(t, n, e, v, h, m, y) {
			...
			if (E && (b = f(E.call(new t))) !== Object.prototype && b.next && (s(b, _, !0), o || "function" ==
					typeof b[l] || a(b, l, p)), S && k && "values" !== k.name && (O = !0, j = function() {
					return k.call(this)
		...
		t.exports = function(t) {
			...
			return void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof(e = function(t, n) {
				...
				}(n = Object(t), r)) ? e : i ? o(n) : "Object" == (a = o(n)) && "function" == typeof n.callee ?
				"Arguments" : a
		}
	}, function(t, n, e) {
		var o = e(91),
		...
		t.exports = Object.getPrototypeOf || function(t) {
			return t = r(t), o(t, i) ? t[i] : "function" == typeof t.constructor && t instanceof t.constructor ?
				t.constructor.prototype : t instanceof Object ? a : null
		}
		...
		d && p || (d = function(t) {
				...
				.port2, r.port1.onmessage = w, o = a(i.postMessage, i, 1)) : f.addEventListener && "function" ==
			typeof postMessage && !f.importScripts ? (o = function(t) {
				f.postMessage(t + "", "*")
		...
		t.exports = function(t) {
			return function(n, e) {
				var i, a, c = String(r(n)),
					u = o(e),
					s = c.length;
				return u < 0 || u >= s ? t ? "" : void 0 : (i = c.charCodeAt(u)) < 55296 || i > 56319 || u +
					1 === s || (a = c.charCodeAt(u + 1)) < 56320 || a > 57343 ? t ? c.charAt(u) : i : t ? c
					.slice(u, u + 2) : a - 56320 + (i - 55296 << 10) + 65536
			}
		}
	}, function(t, n, e) {
		"use strict";
		...
		var o = e(17),
			...
			K = function(t, n, e) {
				return t === B && K(U, n, e), g(t), n = x(n, !0), g(e), r(R, n) ? (e.enumerable ? (r(t, M) && t[M][
					n
				] && (t[M][n] = !1), e = S(e, {
					enumerable: _(0, !1)
			...
			$ = function(t) {
				...
				return !(this === B && r(R, t) && !r(U, t)) && (!(n || !r(this, t) || !r(R, t) || r(this, M) &&
					this[M][t]) || n)
			},
			q = function(t, n) {
			...
			Q = function(t) {
				for (var n, e = I(b(t)), o = [], i = 0; e.length > i;) r(R, n = e[i++]) || n == M || n == u || o
					.push(n);
				return o
			},
			Z = function(t) {
				for (var n, e = t === B, o = I(e ? U : b(t)), i = [], a = 0; o.length > a;) !r(R, n = o[a++]) ||
					e && !r(B, n) || i.push(R[n]);
				return i
			};
		z || (c((L = function() {
					...
					var t = d(arguments.length > 0 ? arguments[0] : void 0),
						n = function(e) {
							this === B && n.call(U, e), r(this, M) && r(this[M], t) && (this[M][t] = !1), G(
								this, t, _(1, e))
						};
					return i && W && G(B, t, {
						configurable: !0,
		...
		a(a.S + a.F * !z, "Symbol", {
			...
			}), L.prototype[D] || e(34)(L.prototype, D, L.prototype.valueOf), l(L, "Symbol"), l(Math, "Math", !0),
			l(o.JSON, "JSON", !0)
	}, function(t, n, e) {
		var o = e(50)("meta"),
			r = e(23),
		...
		var o, r, i, a, c = e(44),
			...
			L = !! function() {
				try {
					...
					return (P || "function" == typeof PromiseRejectionEvent) && t.then(E) instanceof n && 0 !== k
						.indexOf("6.6") && -1 === x.indexOf("Chrome/66")
				} catch (t) {}
			}(),
			A = function(t) {
				var n;
					...
					g((function() {
						for (var o = t._v, r = 1 == t._s, i = 0, a = function(n) {
								var e, i, a, c = r ? n.ok : n.fail,
									...
									f = n.domain;
								try {
									c ? (r || (2 == t._h && N(t), t._h = 1), !0 === c ? e = o : (
											f && f.enter(), e = c(o), f && (f.exit(), a = !0)),
										e === n.promise ? s(S("Promise-chain cycle")) : (i = A(
											e)) ? i.call(e, u, s) : u(e)) : s(o)
								} catch (t) {
									f && !a && f.exit(), s(t)
								}
							}; e.length > i;) a(e[i++]);
			...
			M = function(t) {
				y.call(u, (function() {
					var n, e, o, r = t._v,
						i = D(t);
					if (i && (n = b((function() {
							P ? O.emit("unhandledRejection", r, t) : (e = u
		...
		L || (j = function(t) {
				...
				.prototype = e(176)(j.prototype, {
					then: function(t, n) {
						var e = I(m(this, j));
						return e.ok = "function" != typeof t || t, e.fail = "function" == typeof n && n, e
							.domain = P ? O.domain : void 0, this._c.push(e), this._a && this._a.push(e),
		...
		t.exports = function(t, n) {
			if (t) {
				...
				var e = Object.prototype.toString.call(t)
					.slice(8, -1);
				return "Object" === e && t.constructor && (e = t.constructor.name), "Map" === e || "Set" === e ?
					o(t) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? r(t, n) :
					void 0
			}
		}
	}, function(t, n) {
	...
	function(t, n, e) {
		...
		e.r(n),
			function(t) {
						...
						"iOS" === n.os.name ? t.ajax({
							...
							.then((function(t) {
								if (1 == t.resultCount) {
									...
									(function(t, n) {
										if (t && n) {
											for (var e = t.split("."), r = n.split("."), i = Math.max(e
													.length, r.length), a = 0; a < i; a++)
										...
										.then((function(t) {
											n.nativeUI.confirm(t.note, (function(t) {
												0 == t.index && n.runtime.openURL(
													"http://itunes.apple.com/cn/app/id1477424857?mt=8"
												)
											}), t.title, ["立即更新", "取消"])
										}), (function(t) {}))
								}
								...
								t && "1" == t.status && l()
									.then((function(t) {
										n.nativeUI.confirm(t.note, (function(e) {
											if (0 == e.index) try {
												var o = n.nativeUI.showWaiting(
														"正在下载", {}),
													r = n.downloader.createDownload(
														encodeURI(t.url), {}, (
															function(t, e) {
																n.nativeUI
																	.closeWaiting(),
												...
												r.addEventListener("statechanged",
													i, !1), r.start()
											} catch (t) {
				...
				function v() {
					var n, e, r;
					n = null, e = window.plus, r = e.webview.currentWebview(), e.key.addEventListener("backbutton",
							(function() {
						...
						function() {
							var n = window.plus;
							n.navigator.getStatusbarHeight(), n.navigator.setFullscreen(!1), n.navigator
								.isImmersedStatusbar() || t(".page-header-inner")
								.css({
									"padding-top": 0
								});
							var e = t(".page-header")
					...
					.on("click", (function() {
						...
						function o() {
							...
							window.loadTips((function(t) {
								if (window.plus) {
									e(t), "iOS" !== window.plus.os.name && document.addEventListener(
										"newintent", (function() {
											o()
										}), !1);
									var n = window.plus;
									...
									e(t), window.plus.push.addEventListener("click", (
											function(t) {
												var n = t.payload;
												"iOS" === window.plus.os.name && (n =
													JSON.parse(t.payload));
												var e = window.openUrl(
													"formdata/open", {
														sid: n.form_data_sid,
														lid: n.lid
													});
												location.href = e
											})), "iOS" !== window.plus.os.name && document
										.addEventListener("newintent", (function() {
											o()
										}), !1)
								}), !1)
							})), setTimeout(t, n)
						...
						t.each(t(
								".form-design .assembly-container,.assembly-exteral-component,.assembly-exteral-container"
								),
							(function(n, e) {
								if (!(t(e)
										.find(".assembly-link")
							...
							})), [t("#contract_money"), t("#form_datetime"), t("#form_datetime2")].map((
							function(t) {
								t.next()
									.css({
										position: "relative",
						...
						t(".tag-opinion")
							...
							.find("th.text-center")
							.remove()
					}, window.formatMenu = function(t) {}, window.formatOwl = f, window.formatContract =
					function() {}, window.formatAddOpinion = function() {
						var n = t("#opinion"),
					...
					function() {
						...
						if (["/formdata", "/form", "/flow"].forEach((function(t, e) {
							...
							var e = t(".page-container"),
								o = t('<div style="display:flex;"></div>'),
								r = 0,
								i = 0,
								a = 0;
							o.css({
								...
								c() || (0 == e.scrollTop() && i > 25 ? mycheck(vers) : o.hide("fast"))
							})), e.on("touchmove", (function(t) {
								if (!c() && 1 == t.targetTouches.length && localStorage.getItem(
										'mymode') == 'dark') {
									var n = t.targetTouches[0];
									i = (n.pageY - r) / 7, 0 == e.scrollTop() && i <= 100 && i >= 0 && (
										i - a > 0 ? (o.css({
											display: "flex",
											height: i + "px",
											color: 'white'
										}), i > 25 ? o.text("检查更新") : (o.text("当前版本：" + vers), o
											.css({
												height: i + "px"
											}))) : (o.css({
											display: "flex",
											height: i + "px",
											color: 'white'
										}), i <= 25 && o.text("当前版本：" + vers))), a = i
								} else if (!c() && 1 == t.targetTouches.length) {
									var n = t.targetTouches[0];
									i = (n.pageY - r) / 7, 0 == e.scrollTop() && i <= 100 && i >= 0 && (
										i - a > 0 ? (o.css({
											display: "flex",
